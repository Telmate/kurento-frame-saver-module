 ...
 *              2. 2016-11-20   JBendor     Adapted validated "gst_frame_saver_plugin.c"
 *
...
extern GType gst_frame_saver_plugin_get_type(void); /* body defined by G_DEFINE_TYPE */
	...
	G_DEFINE_TYPE_WITH_CODE (GstFrameSaverPlugin, gst_frame_saver_plugin, GST_TYPE_VIDEO_FILTER,
							 GST_DEBUG_CATEGORY_INIT(gst_frame_saver_plugin_debug_category, THIS_PLUGIN_NAME,
													 0, "debug category for frame_saver_plugin element") );

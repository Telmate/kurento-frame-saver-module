...
src/%.o: ../src/%.c
	...
	gcc -std=c99 -D_LINUX -D_DEBUG -D_LIB -D_USING_PNG_LIBRARY_ -D_USING_SINKER_CAPS_ -I"/home/jonny/Work/TELMATE/GST/ECLIPSE.LNX64.GST150/FrameSaverFilterLibStatic/inc" -I/usr/include/gstreamer-1.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/glib-2.0 -O0 -g3 -c -fmessage-length=0 -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"

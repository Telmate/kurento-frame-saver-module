...
public class PlayMediaPipeline {
  ...
  public PlayMediaPipeline(KurentoClient kurento, String user, final WebSocketSession session) {
    ...
    // connection the video-file-player to the web-RTC-end-point (video-source to video-sink) 
    ...
    {    
        ...
        mFrameSaverProxy.setElementsToSplice( player.getName(), webRtc.getName() );

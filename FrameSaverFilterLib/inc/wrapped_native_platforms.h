/*
 * ======================================================================================
 * File:        wrapped_native_platforms.h
 *
 * Purpose:     wrapper for platform (machine and OS)
 *
...
#if defined _LINUX || defined _LINUX_ || defined __LINUX__ || defined __linux__
...
// macro for capacity of an array    
...
int16_t  nativeGetRandomShort( int16_t maxValue );      // uses (~maxValue) as new seed when (maxValue < 0)
